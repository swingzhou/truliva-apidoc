define({ "api": [
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-truliva-rest/RestServiceDeferredDetailed/getSaleRentDeferredAmountSum",
    "title": "获取服务费递延收益总额",
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-truliva-rest/RestServiceDeferredDetailed/getSaleRentDeferredProfitBalanceSum",
    "title": "获取服务费递延收益余额",
    "name": "getSaleRentDeferredProfitBalanceSum",
    "group": "RestServiceDeferredDetailedController",
    "description": "<p>获取服务费递延收益余额</p>",
    "permission": [
      {
        "name": "userOnly"
      }
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-truliva-rest/RestServiceDeferredDetailed/getSaleRentMaincampBusinessIncomeSum",
    "title": "获取售租订单主营业务收入",
    "name": "getSaleRentMaincampBusinessIncomeSum",
    "group": "RestServiceDeferredDetailedController",
    "description": "<p>获取售租订单主营业务收入</p>",
    "permission": [
      {
        "name": "userOnly"
      }
